...
$sql = "SELECT * FROM district WHERE id_district = '$id_district'";
...
if ($tab == 'overview') {
    ...
    echo "<table class='two-column'>
        <tr>
            <td>".$overview."</td>
            <td><iframe src='district_map.php?tab=overview&id_district=$id_district' height='480px' width='100%'></iframe></td>
        </tr>
    </table>";
    echo "</div>";
    ...
    echo "<table class='two-column'>
        <tr>
            <td>".$livelihood."</td>
            <td><iframe src='district_map.php?tab=livelihood&id_district=$id_district' height='480px' width='100%'></iframe></td>
        </tr>
    </table>";
    echo "</div>";
    ...
    echo "<table class='two-column'>
        <tr>
            <td>".$climate."</td>
            <td><iframe src='district_map.php?tab=climate&id_district=$id_district' height='480px' width='100%'></iframe></td>
        </tr>
    </table>";
    echo "</div>";
    ...
    echo "<table class='two-column'>
        <tr>
            <td>".$disaster."</td>
            <td><iframe src='district_map.php?tab=disaster&id_district=$id_district' height='480px' width='100%'></iframe></td>
        </tr>
    </table>";
    echo "</div>";
    ...
    echo "<table class='two-column'>
        <tr>
            <td>".$water."</td>
            <td><iframe src='district_map.php?tab=water&id_district=$id_district' height='480px' width='100%'></iframe></td>
        </tr>
    </table>";
    echo "</div>";
    ...
    echo "<table class='two-column'>
        <tr>
            <td>".$marine."</td>
            <td><iframe src='district_map.php?tab=marine&id_district=$id_district' height='480px' width='100%'></iframe></td>
        </tr>
    </table>";
    echo "</div>";
    ...
    echo "<table class='two-column'>
        <tr>
            <td>".$agriculture."</td>
            <td><iframe src='district_map.php?tab=agriculture&id_district=$id_district' height='480px' width='100%'></iframe></td>
        </tr>
    </table>";
    echo "</div>";
    ...
    echo "<table class='two-column'>
        <tr>
            <td>".$health."</td>
            <td><iframe src='district_map.php?tab=health&id_district=$id_district' height='480px' width='100%'></iframe></td>
        </tr>
    </table>";
    echo "</div>";
    ...
    echo "<table class='two-column'>
        <tr>
            <td>".$vulnerability."</td>
            <td><iframe src='district_map.php?tab=vulnerability&id_district=$id_district&district=$district' height='480px' width='100%'></iframe></td>
        </tr>
    </table>";
    echo "</div>";
    ...
    echo "<table class='two-column'>
        <tr>
            <td>".$adaptation."</td>
            <td><iframe src='district_map.php?tab=adaptation&id_district=$id_district' height='480px' width='100%'></iframe></td>
        </tr>
    </table>";
    echo "</div>";
